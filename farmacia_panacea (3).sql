...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-06-2025 a las 08:06:29
...
(5, 1, 'Pendiente', 13500.00, '2025-06-16', '2025-06-23', 14, 13500.00);
...
--
ALTER TABLE `pagos_creditos_clientes`
  MODIFY `id_pago_credito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
